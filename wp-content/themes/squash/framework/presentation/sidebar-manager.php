...
class MO_SidebarManager {
    ...
    var $footer_sidebar_descriptions = array();
    ...
    function get_sidebar_element_id($sidebar_id) {
        ...
        $element_id = preg_replace(array('/-post/', '/-page/', '/-blog/'), '', $sidebar_id);
...
/* Make this a global helper function - called all over the theme framework */
