...
class MO_Portfolio_Admin
{
    ...
    <p>
        <label for="portfolio_link">Project URL:</label><br>
    ...
    <p>
        <label for="portfolio_client">Client:</label><br>
        <input id="portfolio_client" name="portfolio_client" type="text" value="<?php echo $portfolio_client;?>"/>
    </p>
    <p>
        <label for="portfolio_date">Project Date:</label><br>
        <input id="portfolio_date" name="portfolio_date" type="text" value="<?php echo $portfolio_date;?>"/>
    </p>
    <p>
        <label for="portfolio_info">Additional Project Notes (HTML accepted):</label><br>
        <textarea rows="8" cols="85" id="portfolio_info" name="portfolio_info"><?php echo $portfolio_info; ?></textarea>
    </p>
