...
function getshortcodeText(selectedShortcode) {
    ...
    if (selectedShortcode == "segment") {
        shortcodeText = '[segment id="" class="" style="" background_url="http://example.com/x.png" background_color="" content_class="" content_style=""]<p>Replace with your segment content here</p>[/segment]';
