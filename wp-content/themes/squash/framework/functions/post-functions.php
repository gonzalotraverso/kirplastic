...
function mo_display_post_nuggets_grid_style($args) {
    ...
    if ($loop->have_posts()) :
        ...
        while ($loop->have_posts()) : $loop->the_post();
            ...
            $thumbnail_exists = mo_thumbnail(array('image_size' => $image_size, 'shadow' => true, 'size' => 'full'));
            ...
            echo '</div> <!-- .style_class for columns -->';
