  ...
  class OT_Meta_Box {
    ...
    function save_meta_box( $post_id, $post_object ) {
      global $pagenow;
        ...
        /* Livemesh - Fix for losing the meta information upon restore of page. Check for ($pagenow == 'revision.php') below will also help */
        if ( empty($_POST) )
            return $post_id;
      ...
      /* Livemesh - Check for $pagenow == 'revision.php' as well to avoid losing post meta information */
