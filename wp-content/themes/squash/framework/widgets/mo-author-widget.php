...
function widget( $args, $instance ) {
	...
	if (isset($title) && empty($title))
		$title = __('About Author', 'mo_theme');
...
?>
	<div id="author-widget" class="clearfix">
		...
		<div class="avatar-wrap">
		<a href="<?php echo $author_posts_url;?>" title="Read all posts of <?php echo $author_name;?>"><?php echo $avatar; ?></a>
		</div>

		<div class='author-name'><?php echo $author_name ?></div>
		<div class='author-desc'><?php echo $author_desc ?></div>
		<ul class ='social-list clearfix'>
		<?php
		if ($twitter_url)
...
function form( $instance ) {
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e('Widget Title:(optional)', 'mo_theme'); ?></label>
		<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" />
	</p>

	<p>
		<label for="<?php echo $this->get_field_id( 'avatar_size' ); ?>"><?php _e('Avatar Size:', 'mo_theme'); ?></label>
		<select class="smallfat"id="<?php echo $this->get_field_id( 'avatar_size' ); ?>" name="<?php echo $this->get_field_name( 'avatar_size' ); ?>" > 
