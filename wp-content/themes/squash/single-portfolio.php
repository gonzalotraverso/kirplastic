    ...
    <?php while (have_posts()) : the_post(); ?>
        ...
        <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            ...
            <div class="portfolio-sidebar threecol last">
                ...
                echo '<div class="portfolio-info" ><h2>' . __('Project Details: ', 'mo_theme') . '</h2></div > ';
                ...
                if (!empty($project_url)) {
                    echo '<div class="portfolio-link" ><a href = "' . $project_url . '" class="button squash">' . __('Visit Website', 'mo_theme') . '</a></div > ';
                }
