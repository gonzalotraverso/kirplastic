  ...
  class OT_Loader {
    ...
    public function constants() {
      ...
      if ( false == OT_THEME_MODE ) {
        ...
        /* ----------- Modified for Squash theme --------------*/
        define( 'OT_DIR', trailingslashit( get_template_directory() ) . 'framework/' . trailingslashit( basename( dirname( __FILE__ ) ) ) );
        define( 'OT_URL', trailingslashit( get_template_directory_uri() ) . 'framework/'. trailingslashit( basename( dirname( __FILE__ ) ) ) );
      }
